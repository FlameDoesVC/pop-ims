    ...
    def delete(self):
        id = inquirer.prompt(
            [
                ...
                inquirer.Confirm(
                    "confirm",
                    message=lambda answers: f"Are you sure you want to delete item id {answers['id']}?",
                    default=True,
                ),
            ]
        )
    ...
    def delete():
        id = inquirer.prompt(
            [
                ...
                inquirer.Confirm(
                    "confirm",
                    message=lambda answers: f"Are you sure you want to delete order id {answers['id']}?",
                    default=True,
                ),
            ]
        )
